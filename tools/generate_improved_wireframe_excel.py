...
def _carta_rows() -> list[Sequence[str | None]]:
    ...
    rows = [
        ...
        ("Tipo_entrevista", "Tipo de entrevista.", "Colaboradores > Flag", "Involucrado o Informativo"),
        ("FECHA", "Fecha de generación en plantilla.", "Sistema", "YYYY-MM-DD"),
...
def _catalog_rows() -> list[Sequence[str | None]]:
    ...
    rows = [
        ...
        ("product_details.csv", "id_producto", "Productos - ID del producto", "Clave de búsqueda", "Catálogo opcional."),
        ("product_details.csv", "id_cliente", "Productos - Cliente", "Sí", "Autopobla titular."),
        ("product_details.csv", "tipo_producto", "Productos - Tipo de producto", "Sí", ""),
        ("product_details.csv", "categoria1", "Productos - Categoría 1", "Sí", ""),
        ("product_details.csv", "categoria2", "Productos - Categoría 2", "Sí", ""),
        ("product_details.csv", "modalidad", "Productos - Modalidad", "Sí", ""),
        ("product_details.csv", "canal", "Productos - Canal", "Sí", ""),
        ("product_details.csv", "proceso", "Productos - Proceso", "Sí", ""),
        ("product_details.csv", "fecha_ocurrencia", "Productos - Fecha de ocurrencia", "Sí", ""),
        ("product_details.csv", "fecha_descubrimiento", "Productos - Fecha de descubrimiento", "Sí", ""),
        ("product_details.csv", "monto_investigado", "Productos - Monto investigado", "Sí", ""),
        ("product_details.csv", "tipo_moneda", "Productos - Moneda", "Sí", ""),
        ("product_details.csv", "monto_perdida_fraude", "Productos - Monto pérdida fraude", "Sí", ""),
        ("product_details.csv", "monto_falla_procesos", "Productos - Monto falla procesos", "Sí", ""),
        ("product_details.csv", "monto_contingencia", "Productos - Monto contingencia", "Sí", ""),
        ("product_details.csv", "monto_recuperado", "Productos - Monto recuperado", "Sí", ""),
        ("product_details.csv", "monto_pago_deuda", "Productos - Monto pago deuda", "Sí", ""),
