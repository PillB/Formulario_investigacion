...
SUMMARY_CASES = [
    ...
    SummaryPasteCase(
        ...
        valid_row=["C12345678", "2024-0001", "1234567890123", "Analítica", "4300000000"],
        invalid_row=["123", "2024-0001", "", "", "000"],
    ...
    SummaryPasteCase(
        key="riesgos",
        columns=build_columns(7),
        valid_row=["RSK-000001", "2024-0001", "Líder", "Descripción breve", CRITICIDAD_LIST[0], "100.00", "Plan"],
        invalid_row=["RSK-000001", "2024-0001", "Líder", "Descripción", "INVÁLIDO", "abc", ""],
    ...
    SummaryPasteCase(
        key="normas",
        columns=build_columns(6),
        valid_row=["2024.001.01.01", "2024-0001", "Descripción", "2024-01-01", "Art. 1", "Detalle"],
        invalid_row=["2024.001.01.01", "2024-0001", "Descripción", "2024/01/01", "Art. 1", "Detalle"],
